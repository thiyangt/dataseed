#' Phylogenetic data files recording body mass, brain volume and brain mass: teleost
#'
#'@description Phylogenetic data files recording body mass, brain volume and brain mass of teleost by Tsuboi, M., van der Bijl, W., Kopperud, B.T., Erritzøe, J., Voje, K.L., Kotrschal, A., Yopak, K.E., Collin, S.P., Iwaniuk, A.N. and Kolm, N., 2018. Breakdown of brain–body allometry and the encephalization of birds and mammals. Nature Ecology & Evolution, 2(9), pp.1492-1500.
#'@format A data frame with 3824 rows and 17 variables
#'\description{
#'\item{Order}{Order}
#'\item{Family}{Family}
#'\item{Genus}{Genus}
...
#'\item{Body weight (g)}{Body weight (g)}
#'\item{Brain weight (g)}{Brain weight (g)}
#'\item{Standard length (cm)}{Standard length (cm)}
#'\item{Total length (cm)}{Total length (cm)}
