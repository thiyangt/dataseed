#' Phylogenetic data files recording body mass, brain volume and brain mass: birds
#'
...
#'\item{Body mass (g)}{Body mass in grams}
#'\item{Specimen ID}{Specimen ID}
#'\item{Museum}{Museum}
#'\item{Date (mm-dd-yyyy)}{Date}
