#' Phylogenetic data files recording body mass, brain volume and brain mass: shark ray
#'
#'@description Phylogenetic data files recording body mass, brain volume and brain mass of shark ray by Tsuboi, M., van der Bijl, W., Kopperud, B.T., Erritzøe, J., Voje, K.L., Kotrschal, A., Yopak, K.E., Collin, S.P., Iwaniuk, A.N. and Kolm, N., 2018. Breakdown of brain–body allometry and the encephalization of birds and mammals. Nature Ecology & Evolution, 2(9), pp.1492-1500.
#'@format A data frame with 450 rows and 18 variables
#'\describe{
#'\item{Order}{Order}
#'\item{Family}{Family}
#'\item{Genus}{Genus}
