#' Phylogenetic data files recording body mass, brain volume and brain mass: amphibians
#'
#'@description Phylogenetic data files recording body mass, brain volume and brain mass of amphibians by Tsuboi, M., van der Bijl, W., Kopperud, B.T., Erritzøe, J., Voje, K.L., Kotrschal, A., Yopak, K.E., Collin, S.P., Iwaniuk, A.N. and Kolm, N., 2018. Breakdown of brain–body allometry and the encephalization of birds and mammals. Nature Ecology & Evolution, 2(9), pp.1492-1500.
#'@format A data frame with 514 rows and 17 variables
#'\description{
#'\item{Order}{Order}
#'\item{Family}{Family}
#'\item{Genus}{Genus}
...
#'\item{Sample size}{The sample size used to estimate static allometries}
#'\item{Sex}{Gender: m-male, f-female}
#'\item{Method}{Method of measuring brain size}
#'\item{Body weight (g)}{Body weight in grams}
#'\item{SVL (mm)}{Snout-Vent Length in mm}
#'\item{Brain weight (g)}{Brain weight in grams}
#'\item{Brain volume (mm3)}{Brain volume}
